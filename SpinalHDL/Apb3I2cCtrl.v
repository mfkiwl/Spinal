...
module Apb3I2cCtrl (
  ...
  reg                 _zz_5;
  reg        [31:0]   bridge_masterLogic_timer_value;
  reg        [31:0]   bridge_masterLogic_timer_tLow;
  reg        [31:0]   bridge_masterLogic_timer_tHigh;
  reg        [31:0]   bridge_masterLogic_timer_tBuf;
  ...
  reg                 _zz_10;
  reg        [9:0]    _zz_11;
  reg        [19:0]   _zz_12 = 20'b00000000000000000000;
  reg        [5:0]    _zz_13 = 6'b000000;
  ...
  assign _zz_17 = (bridge_masterLogic_stop && (! bridge_inAckState));
  assign _zz_18 = (bridge_masterLogic_start && (! bridge_inAckState));
  assign _zz_19 = ((i2cCtrl_io_bus_cmd_kind == `I2cSlaveCmdMode_binary_sequential_STOP) || (i2cCtrl_io_bus_cmd_kind == `I2cSlaveCmdMode_binary_sequential_DROP));
  assign _zz_20 = (! bridge_inAckState);
  assign _zz_21 = (bridge_wasntAck && (! bridge_masterLogic_fsm_isBusy));
  assign _zz_22 = ((! i2cCtrl_io_internals_inFrame) && i2cCtrl_io_internals_inFrame_regNext);
  assign _zz_23 = (bridge_masterLogic_start && (! bridge_masterLogic_fsm_inFrameLate));
  assign _zz_24 = (bridge_masterLogic_drop || ((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_IDLE)) && (i2cCtrl_io_bus_cmd_kind == `I2cSlaveCmdMode_binary_sequential_DROP)));
  assign _zz_25 = (! bridge_inAckState);
  ...
  assign _zz_31 = 1'b1;
  assign _zz_32 = (! bridge_masterLogic_timer_done);
  assign _zz_33 = {31'd0, _zz_32};
  assign _zz_34 = (3'b111 - bridge_dataCounter);
  assign _zz_35 = (3'b111 - bridge_dataCounter);
  assign _zz_36 = io_apb_PWDATA[4 : 4];
  assign _zz_37 = 1'b0;
  assign _zz_38 = io_apb_PWDATA[5 : 5];
  assign _zz_39 = 1'b0;
  assign _zz_40 = io_apb_PWDATA[6 : 6];
  assign _zz_41 = 1'b0;
  assign _zz_42 = io_apb_PWDATA[7 : 7];
  assign _zz_43 = 1'b0;
  assign _zz_44 = io_apb_PWDATA[16 : 16];
  assign _zz_45 = 1'b0;
  assign _zz_46 = io_apb_PWDATA[9 : 9];
  assign _zz_47 = io_apb_PWDATA[9 : 9];
  assign _zz_48 = io_apb_PWDATA[10 : 10];
  assign _zz_49 = io_apb_PWDATA[11 : 11];
  assign _zz_50 = io_apb_PWDATA[8 : 8];
  assign _zz_51 = io_apb_PWDATA[9 : 9];
  assign _zz_52 = io_apb_PWDATA[0 : 0];
  assign _zz_53 = io_apb_PWDATA[10 : 10];
  assign _zz_54 = io_apb_PWDATA[11 : 11];
  assign _zz_55 = io_apb_PWDATA[8 : 8];
  assign _zz_56 = io_apb_PWDATA[9 : 9];
  assign _zz_57 = io_apb_PWDATA[0 : 0];
  assign _zz_58 = io_apb_PWDATA[1 : 1];
  assign _zz_59 = io_apb_PWDATA[2 : 2];
  assign _zz_60 = io_apb_PWDATA[3 : 3];
  assign _zz_61 = io_apb_PWDATA[4 : 4];
  assign _zz_62 = io_apb_PWDATA[5 : 5];
  assign _zz_63 = io_apb_PWDATA[6 : 6];
  assign _zz_64 = io_apb_PWDATA[7 : 7];
  assign _zz_65 = io_apb_PWDATA[16 : 16];
  I2cSlave i2cCtrl (
    ...
    .io_config_samplingClockDivider    (_zz_11[9:0]                   ), //i
    .io_config_timeout                 (_zz_12[19:0]                  ), //i
    .io_config_tsuData                 (_zz_13[5:0]                   ), //i
    .io_bus_cmd_kind                   (i2cCtrl_io_bus_cmd_kind[2:0]  ), //o
    .io_bus_cmd_data                   (i2cCtrl_io_bus_cmd_data       ), //o
    .io_bus_rsp_valid                  (_zz_14                        ), //i
    .io_bus_rsp_enable                 (_zz_15                        ), //i
    .io_bus_rsp_data                   (_zz_16                        ), //i
  ...
  assign bridge_masterLogic_timer_done = (bridge_masterLogic_timer_value == 32'h0);
  ...
  always @ (*) begin
    if(_zz_20)begin
      _zz_14 = ((bridge_txData_valid && (! (bridge_rxData_valid && bridge_rxData_listen))) && (i2cCtrl_io_bus_cmd_kind == `I2cSlaveCmdMode_binary_sequential_DRIVE));
      if(bridge_txData_forceDisable)begin
        _zz_14 = 1'b1;
      end
    end else begin
      _zz_14 = ((bridge_txAck_valid && (! (bridge_rxAck_valid && bridge_rxAck_listen))) && (i2cCtrl_io_bus_cmd_kind == `I2cSlaveCmdMode_binary_sequential_DRIVE));
      if(bridge_txAck_forceAck)begin
        _zz_14 = 1'b1;
      end
    end
    if(_zz_21)begin
      _zz_14 = (i2cCtrl_io_bus_cmd_kind == `I2cSlaveCmdMode_binary_sequential_DRIVE);
    end
  end

  always @ (*) begin
    if(_zz_20)begin
      _zz_15 = bridge_txData_enable;
      if(bridge_txData_forceDisable)begin
        _zz_15 = 1'b0;
      end
    end else begin
      _zz_15 = bridge_txAck_enable;
      if(bridge_txAck_forceAck)begin
        _zz_15 = 1'b1;
      end
    end
  ...
  always @ (*) begin
    if(_zz_20)begin
      _zz_16 = bridge_txData_value[_zz_34];
    end else begin
      _zz_16 = bridge_txAck_value;
      if(bridge_txAck_forceAck)begin
        _zz_16 = 1'b0;
      end
    end
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      if(_zz_3)begin
        if(_zz_26[0])begin
          bridge_masterLogic_start <= _zz_27[0];
        end
      end
      if(_zz_4)begin
        if(_zz_28[0])begin
          bridge_masterLogic_stop <= _zz_29[0];
        end
      end
      if(_zz_5)begin
        if(_zz_30[0])begin
          bridge_masterLogic_drop <= _zz_31[0];
        end
      end
      case(i2cCtrl_io_bus_cmd_kind)
        `I2cSlaveCmdMode_binary_sequential_READ : begin
          if(_zz_25)begin
            ...
            if((_zz_16 != i2cCtrl_io_bus_cmd_data))begin
      ...
      if(_zz_6)begin
        if(_zz_36[0])begin
          bridge_interruptCtrl_start_flag <= _zz_37[0];
        end
      end
      ...
      if(_zz_7)begin
        if(_zz_38[0])begin
          bridge_interruptCtrl_restart_flag <= _zz_39[0];
        end
      end
      ...
      if(_zz_8)begin
        if(_zz_40[0])begin
          bridge_interruptCtrl_end_flag <= _zz_41[0];
        end
      end
      ...
      if(_zz_9)begin
        if(_zz_42[0])begin
          bridge_interruptCtrl_drop_flag <= _zz_43[0];
        end
      end
      ...
      if(_zz_10)begin
        if(_zz_44[0])begin
          bridge_interruptCtrl_clockGen_flag <= _zz_45[0];
        end
      end
      ...
      case(io_apb_PADDR)
        8'h08 : begin
          if(busCtrl_doWrite)begin
            bridge_rxData_listen <= _zz_46[0];
          end
        end
        8'h0c : begin
          if(busCtrl_doWrite)begin
            bridge_rxAck_listen <= _zz_47[0];
          end
        end
        8'h0 : begin
          if(busCtrl_doWrite)begin
            bridge_txData_repeat <= _zz_48[0];
            bridge_txData_valid <= _zz_50[0];
            bridge_txData_enable <= _zz_51[0];
          end
        end
        8'h04 : begin
          if(busCtrl_doWrite)begin
            bridge_txAck_repeat <= _zz_53[0];
            bridge_txAck_valid <= _zz_55[0];
            bridge_txAck_enable <= _zz_56[0];
          end
        end
        8'h20 : begin
          if(busCtrl_doWrite)begin
            bridge_interruptCtrl_rxDataEnable <= _zz_57[0];
            bridge_interruptCtrl_rxAckEnable <= _zz_58[0];
            bridge_interruptCtrl_txDataEnable <= _zz_59[0];
            bridge_interruptCtrl_txAckEnable <= _zz_60[0];
            bridge_interruptCtrl_start_enable <= _zz_61[0];
            bridge_interruptCtrl_restart_enable <= _zz_62[0];
            bridge_interruptCtrl_end_enable <= _zz_63[0];
            bridge_interruptCtrl_drop_enable <= _zz_64[0];
            bridge_interruptCtrl_clockGen_enable <= _zz_65[0];
          end
        end
        8'h28 : begin
          if(busCtrl_doWrite)begin
            _zz_11 <= io_apb_PWDATA[9 : 0];
          end
        end
        default : begin
        end
  ...
  always @ (posedge clk) begin
    bridge_masterLogic_timer_value <= (bridge_masterLogic_timer_value - _zz_33);
    if((! i2cCtrl_io_internals_sclRead))begin
    ...
    case(i2cCtrl_io_bus_cmd_kind)
      `I2cSlaveCmdMode_binary_sequential_READ : begin
        if(_zz_25)begin
          bridge_rxData_value[_zz_35] <= i2cCtrl_io_bus_cmd_data;
        end else begin
    ...
    case(io_apb_PADDR)
      8'h0 : begin
        if(busCtrl_doWrite)begin
          ...
          bridge_txData_disableOnDataConflict <= _zz_49[0];
        end
      end
      8'h04 : begin
        if(busCtrl_doWrite)begin
          bridge_txAck_value <= _zz_52[0];
          bridge_txAck_disableOnDataConflict <= _zz_54[0];
        end
      end
      8'h50 : begin
        if(busCtrl_doWrite)begin
          bridge_masterLogic_timer_tLow <= io_apb_PWDATA[31 : 0];
        end
      end
      8'h54 : begin
        if(busCtrl_doWrite)begin
          bridge_masterLogic_timer_tHigh <= io_apb_PWDATA[31 : 0];
        end
      end
      8'h58 : begin
        if(busCtrl_doWrite)begin
          bridge_masterLogic_timer_tBuf <= io_apb_PWDATA[31 : 0];
        end
      end
      8'h2c : begin
        if(busCtrl_doWrite)begin
          _zz_12 <= io_apb_PWDATA[19 : 0];
        end
      end
      8'h30 : begin
        if(busCtrl_doWrite)begin
          _zz_13 <= io_apb_PWDATA[5 : 0];
        end
      end
      default : begin
      end
    ...
    endcase
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_START1)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_START1)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tHigh;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_START2)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_START2)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tLow;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_LOW)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_LOW)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tLow;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_HIGH)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_HIGH)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tHigh;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_RESTART)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_RESTART)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tHigh;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_STOP1)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_STOP1)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tHigh;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_STOP2)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_STOP2)))begin
      bridge_masterLogic_timer_value <= bridge_masterLogic_timer_tHigh;
    end
    if(((! (bridge_masterLogic_fsm_stateReg == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_TBUF)) && (bridge_masterLogic_fsm_stateNext == `bridge_masterLogic_fsm_enumDefinition_binary_sequential_bridge_masterLogic_fsm_TBUF)))begin
